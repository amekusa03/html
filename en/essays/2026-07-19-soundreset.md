...
Adjusted to maximize favorites with current resources.

## Front speaker (Pioneer TS-F1740Ⅱ)

* HPF (bass cut): 63 Hz
* LPF (treble cut): 20.6 kHz
* Slope: -12 dB/oct
...
* Slope: -24 dB/oct
* Filter type: Linkwitz-Riley
* Limiter AT.Time 29ms Re.Time Atk16
* Considering the connection with the front desk, the LPF is high.
...
However, I am dissatisfied with the rear speakers.
Considering the cost and removing the lining, I hesitate.
Is this the swamp of audio?
